...
// Rename Popcron.Gizmos to RuntimeGizmos
public class RuntimeGizmos : Popcron.Gizmos
{
}
    ...
    public class Gizmos
    {
        ...
        { 
            ...
            set
            {
                ...
                {
                    throw new Exception("Don't change Gizmos.enabled state outside of playmode");
                }
            }
        }
